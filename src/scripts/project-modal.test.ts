...
const project = {
  ...
  caseVideo: {
    ...
    src: '/assets/placeholders/tresor-showcase.webm',
...
describe('initProjectModal', () => {
  it('abre o modal com os dados do projeto e fecha ao pressionar Escape', () => {
    ...
    const link = document.querySelector<HTMLAnchorElement>(
      '[data-project-modal-link]',
    );
    const video = document.querySelector<HTMLVideoElement>(
      '[data-project-modal-video]',
    );
    const primary = document.querySelector<HTMLElement>(
      '.project-modal-primary',
    );
    const source = document.querySelector<HTMLSourceElement>(
      '[data-project-modal-video-source]',
    );
    const gallery = document.querySelector<HTMLImageElement>(
      '[data-project-modal-gallery-image]',
    );
    const galleryCount = document.querySelector<HTMLElement>(
      '[data-project-modal-gallery-count]',
    );
    const galleryNext = document.querySelector<HTMLButtonElement>(
      '[data-project-modal-gallery-next]',
    );
    const galleryOpen = document.querySelector<HTMLButtonElement>(
      '[data-project-modal-gallery-open]',
    );
